...
@ComponentScan(basePackages = { "com.clothing.management.repository", "com.clothing.management.entities" })
@EnableJpaRepositories(basePackages = { "com.clothing.management.repository"},
...
public class TenantDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emfBean.setPackagesToScan("com.clothing.management");
