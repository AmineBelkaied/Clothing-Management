...
public class PacketServiceImpl implements PacketService {
    ...
    public List<Packet> findSyncPackets() {
        ...
        List<Packet> syncPackets = packetRepository.findAllValidByStatusPackets(status);
    ...
    public List<DashboardCard> syncNotification(String searchField,String beginDate, String endDate) {
        List<DashboardCard> notifications = packetRepository.createNotification(searchField,beginDate, endDate);
