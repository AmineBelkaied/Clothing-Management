...
public class MasterTenant implements Serializable {
    ...
    public MasterTenant(Integer tenantClientId, String dbName, String url, String userName, String password, String driverClass, String tenantName, String status) {
